export default function Heading({ icon: Icon, title, description }) {
  return (
    <header className="relative mb-10 pb-8 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-slate-200 after:to-transparent">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-[1.65rem] sm:leading-snug">
            {title}
          </h1>
          <p className="mt-1.5 max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-[0.9375rem]">
            {description}
          </p>
        </div>
      </div>
